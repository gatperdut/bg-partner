...
export class Effs {
  ...
  public static effsIgnored: EffKey[] = [
    ...
    154, 155, 156, 158, 169, 170, 173, 174, 177, 184, 186, 187, 208, 215, 233, 240, 265, 267, 271,
    275, 276, 277, 282, 283, 287, 290, 291, 293, 295, 296, 297, 309, 313, 315, 327, 328, 330, 336,
    360,
  ];
