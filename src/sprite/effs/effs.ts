...
export class Effs {
  ...
  public static effsIgnored: EffKey[] = [
    ...
    65, 66, 84, 85, 90, 91, 92, 103, 114, 119, 135, 138, 139, 140, 141, 142, 144, 145, 146, 153,
    154, 155, 156, 158, 169, 170, 174, 177, 184, 186, 187, 215, 240, 265, 267, 271, 275, 276, 277,
    282, 283, 287, 290, 291, 293, 295, 296, 309, 313, 315, 327, 330, 336,
  ];

  public static effsGrouped: number[] = [0, 83, 102, 200, 201, 259];

  public static effsSqueezes: number[][] = [[248, 249], [101], [197], [86, 87, 88, 89]];
