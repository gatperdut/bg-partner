...
export class WindowLinux extends WindowOs {
  ...
  public run(): void {
    ...
    this.rectangle.x = wmctrlValues[1];

    this.rectangle.y = wmctrlValues[2] - windowTitleHeight;

    this.rectangle.width = wmctrlValues[3];

    this.rectangle.height = wmctrlValues[4];
  }
